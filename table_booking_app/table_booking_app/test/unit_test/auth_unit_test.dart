...
import 'package:table_booking_app/core/failure/failure.dart';
import 'package:table_booking_app/features/auth/domain/entity/user_entity.dart';
import 'package:table_booking_app/features/auth/domain/use_case/auth_usecase.dart';
import 'package:table_booking_app/features/auth/presentation/viewmodel/auth_view_model.dart';
...
void main() {
  ...
  group('Test cases for login', () {
    test('should login with valid user accrount credentials', () async {
      // creat Stub
      when(mockAuthUseCase.loginUser('testing', 'testing'))
    ...
    test('should throw error with invalid account credentials', () async {
      when(mockAuthUseCase.loginUser('testing', 'testing2'))
  ...
  group('Test cases for sign up', () {
    test('should signup successfully with null error', () async {
      // user details
      UserEntity newUser = const UserEntity(
